...
const AboutPage = () => {
  return (
    <>
      <h3>About Me</h3><br/>
      <ul>
        <li><span role="img" aria-label="book">📖</span> Hi, I'm Astra Clelia Bertelli, a 21-years-old student and (bio)informatics geek currently studying Biological Sciences at <a href='https://dbb.dip.unipv.it/en'>University of Pavia (Italy)</a>. I'm also currently Founding Engineer at Criad LTD.</li>
